...
public class TestIntegrationsAndPartnersLink {
	...
	public void closeDriver() {
		...
		@Test
		public void testClickOnIntegrationsAndPartners() {
			
			CompanyHumanity.clickOnIntegrationsAndPartners(driver);
			
			String currentURL = driver.getCurrentUrl();
			String expectedURL = "https://www.humanity.com/integrations";
